...
public class Aurkezpena extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Aurkezpena3 frame = new Aurkezpena3();
	...
	public Aurkezpena() {
		...
		rdbtnIrakaslea = new JRadioButton("a");
		buttonGroup.add(rdbtnIrakaslea);
		rdbtnIrakaslea.setBounds(207, 114, 48, 23);
		contentPane.add(rdbtnIrakaslea);
		
		rdbtnIkaslea = new JRadioButton("b");
		buttonGroup.add(rdbtnIkaslea);
		rdbtnIkaslea.setBounds(271, 114, 48, 23);
		contentPane.add(rdbtnIkaslea);
	}
	public void setNeogozioLogica (Login1 nl){
		negozioLogika=nl;
	}
}
